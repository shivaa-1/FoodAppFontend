...
<nav className="bg-gray-200 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <div className="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg bg-gray-300 md:flex-row md:space-x-8 md:mt-0">
      <li>
        <Link to="/createfooditem" className="block py-2 pl-3 pr-4 text-white bg-blue-500 rounded-lg" aria-current="page">Add New Food Item</Link>
      </li>
    </ul>
  </div>
  </div>

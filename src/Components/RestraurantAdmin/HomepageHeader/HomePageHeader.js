...
const HomePageHeader = ({restaurantToken,setRestauranttoken}) => {
    return (
        <div>
    ...
    <nav class="flex justify-between bg-gray-900 text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          <li><Link class="hover:text-gray-200" to="/createfooditem">Create Food Item</Link></li>
          <li><Link class="hover:text-gray-200" to="/">Catagory</Link></li>
          <li><Link class="hover:text-gray-200" to="/">Collections</Link></li>
          <li><Link class="hover:text-gray-200" to="/">Contact Us</Link></li>
        </ul>
        {/* <!-- Header Icons --> */}

...
{/* <!-- Profile Card --> */}
<div class="rounded-lg about shadow-lg bg-gray-600 w-full flex flex-row flex-wrap p-3 antialiased">
  <div class="md:w-2/3 w-full my-4">
  <div class="text-2xl text-white leading-tight my-5">Start your journey with FoodApp</div>
      <div class="text-normal text-gray-300 hover:text-gray-400 cursor-pointer"><span class="border-b border-dashed border-gray-500 pb-1">Create your restaurant page and register for online ordering</span></div>
  ...
  <div class="md:w-1/3 w-full px-3 flex flex-row flex-wrap">
    <div class="w-full text-right text-gray-700 font-semibold relative pt-3 md:pt-0">
      ...
      <div class="text-sm mb-3 text-gray-300 hover:text-gray-400 cursor-pointer md:absolute pt-3 md:pt-0 bottom-0 right-0"><Link to="/registerrestaurant" className="registeruser bg-blue-400 px-3 text-black font-bold py-2 rounded-lg hover:text-white">Start Now <ArrowForwardIosRoundedIcon/></Link></div>
    </div>
  </div>
</div>
{/* <!-- End Profile Card --> */}
